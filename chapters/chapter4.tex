...
\section{Sprint 3: Gestion de la Paie, des Congés et des Documents Administratifs}
...
\begin{itemize}
    \item \textbf{Date de début du sprint} : 01/04/2026
    \item \textbf{Date de fin du sprint} : 30/04/2026
\end{itemize}
...
24 & Consulter primes & Employé & consulter mes primes & connaître mes avantages & 2 & 1 \\ \hline
25 & Consulter déductions & Employé & voir mes déductions & comprendre ma paie & 2 & 1 \\ \hline
26 & Consulter salaire & Employé & voir mon salaire & vérifier paiement & 3 & 1 \\ \hline
27 & Demande congé & Employé & envoyer une demande & obtenir une absence & 5 & 2 \\ \hline
28 & Déposer document & Employé & déposer un document & justifier une absence & 4 & 3 \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 3/use case s3.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 3/raffinement gerer congés.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 3/refinnement gere salaire .drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 3/Gérer document.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/sequence s3/mis ajour salaire.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/sequence s3/consulter primes et deductions .drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/sequence s3/consulter deductions .drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/sequence s3/consulrer salaires .drawio.png}
...
\begin{itemize}
    \item \textbf{Date de début du sprint} : 01/05/2026
    \item \textbf{Date de fin du sprint} : 31/05/2026
\end{itemize}
...
20 & Exporter rapport                 & Responsable RH   & générer des rapports                        & analyser les données RH       & 3 & 3 \\ \hline

31 & Consulter historique             & Responsable RH   & consulter l'historique des actions RH       & assurer la traçabilité        & 4 & 3 \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 4/diagramme de sprint 4.drawio.png}
...
\item \textbf{Raffinement du cas d'utilisation "Gérer historique et rapports "}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint 4/consulter historique .drawio (2).png}
    \caption{Raffinement du cas d'utilisation "Gérer historique et rapports"}
    \label{fig:raffinement_historique}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramme de séquence du cas d'utilisation «~Payer frais~»}
\end{figure}
...
\begin{center}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{projet/images/interface/s4/dashbord admin.jpg}
...
\begin{center}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{projet/images/interface/s4/dashbord rh.jpeg}
