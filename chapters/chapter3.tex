...
\begin{itemize}
    \item \textbf{Date de début du sprint} : 01/02/2026
    \item \textbf{Date de fin du sprint} : 28/02/2026
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint1/use case sprint 1.drawio (1).png}
    \caption{Diagramme de Cas d'utilisation du Sprint 1}
    \label{fig:usecase1}
\end{figure}

Afin de mieux comprendre les fonctionnalités, nous allons établir leurs raffinements avec une description détaillée des différents scénarios possibles. Pour chaque fonctionnalité, nous présentons son diagramme de cas d'utilisation raffiné, suivi par son diagramme de séquence acteur/système et nous allons établir sa description textuelle. Pour éviter la redondance, on a choisi de ne pas détailler certains cas d'utilisation.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint1/Gréer compte employé.drawio (1).png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/usecase/sprint1/gere compte rh.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/difg/ss1/sinscrire.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/difg/ss1/Créer compte employé.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/classe finale/diagramme de clasee s1 version finale.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/interface/s1/inscire.jpeg}
...
\begin{itemize}
    \item \textbf{Date de début du sprint} : 01/03/2026
    \item \textbf{Date de fin du sprint} : 31/03/2026
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{projet/images/img diag sprint 2/connecter cameras .drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{projet/images/img diag sprint 2/enregister visage drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{projet/images/img diag sprint 2/modifier infos .drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{projet/images/img diag sprint 2/consluter retard drawio.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{projet/images/classe finale/daigramme de classse s2 .drawio.png}
