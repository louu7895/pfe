...
Ce diagramme illustre le processus de traitement d’une demande de congé par le Responsable RH.

Après avoir consulté la liste des demandes en attente, le Responsable RH sélectionne la demande à traiter puis décide de l’approuver ou de la refuser. Le système enregistre ensuite la décision prise dans la base de données en mettant à jour le statut de la demande
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/gerer conger.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/attribuer bounuses.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/mis_ajour_salaire.png}
...
Ce diagramme illustre le processus de modification du salaire de base d’un employé par le Responsable RH. Après avoir sélectionné l’employé concerné, le Responsable RH saisit le nouveau montant du salaire de base. Le système vérifie les informations fournies puis enregistre la modification dans la base de données afin de mettre à jour les informations salariales de l’employé.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/Modifier salaire.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/_consulter documents.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/gerer s document.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/consulter primes et deductions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/consulter_salaires.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/demander conges.drawio.png}
...
Ce diagramme décrit le dépôt d'un document justificatif par l'employé. Il sélectionne le fichier à soumettre, saisit les informations nécessaires et le système enregistre le document.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/digf/ss3/deposer documents.drawio.png}
...
Ce diagramme décrit le fonctionnement du tableau de bord administrateur. Celui-ci fournit une vue globale des activités effectuées par les responsables RH au sein du système.. Les informations affichées permettent un suivi en temps réel des activités, facilitent le contrôle administratif et garantissent la transparence des opérations réalisées.
\begin{figure}[H]
    \centering
...
Ce cas d’utilisation permet au Responsable RH de consulter un tableau de bord centralisant les principales informations relatives aux employés. Il affiche notamment le nombre total d’employés présents ainsi que les dernières activités effectuées par les employés au sein du système. Ces indicateurs offrent une vue synthétique de l’état des ressources humaines et facilitent le suivi quotidien des activités de l’entreprise.
...
Ce diagramme de séquence illustre les interactions permettant au Responsable RH de consulter une vue globale de la présence au sein de l’entreprise. Le système récupère les données enregistrées dans la base de données, notamment le nombre d’employés présents, absents , puis les affiche sous forme d’informations synthétiques. Cette fonctionnalité permet au Responsable RH de suivre l’état global des effectifs et d’obtenir une vision claire de la présence des employés au sein de l’entreprise.
...
Ce diagramme de séquence dépeint la procédure de création d'un rapport par le Responsable des Ressources Humaines. L'utilisateur choisit les paramètres du rapport désiré puis soumet une requête au système. Il extrait les données nécessaires de la base de données, les analyse et produit le rapport approprié. Finalement, le rapport est présenté ou diffusé pour permettre son utilisation et son analyse.
