...
Ce tableau décrit le cas d'utilisation d'authentification, couvrant l'ensemble du flux depuis la saisie des identifiants jusqu'à la redirection vers le tableau de bord, tout en intégrant la vérification du statut du compte de l'employé et en traitant les cas d'exception liés à des identifiants invalides ou à un compte désactivé.
\begin{center}
...
7. Le système contrôle le statut du compte (actif / désactivé / bloqué). \newline
8. Si le compte est actif, le système valide la connexion. \newline
9. Le système affiche le tableau de bord. \newline
10. L'utilisateur est redirigé avec succès.\\ \hline

\textbf{Scénario d'exception} &
1.1 Si les identifiants sont invalides : \newline
Le système affiche un message d'erreur. \newline
1.2 Si le compte est suspendu : \newline
Le système refuse l'accès et affiche un message approprié. \\ \hline
...
\textbf{Scénario nominal} &
\textbf{Modification :} \newline
9. Le Responsable RH ccède à la liste des employés. \newline
...
Les diagrammes de séquence présentés ci-dessous illustrent le déroulement temporel des interactions entre les acteurs et le système pour chaque fonctionnalité développée durant ce sprint. Ils
permettent de visualiser l’enchaînement précis des messages échangés entre les différentes couches
de l’architecture, à savoir le frontend Next.js, le backend Flask et la base de données.

\subsubsection*{Diagramme de séquence du cas d'utilisation « S'authentifier »}

 Ce diagramme de séquence illustre le flux d'authentification d'un utilisateur au sein de la plateforme.Ce diagramme de séquence illustre le flux d'authentification d'un utilisateur au sein de la plateforme. L'utilisateur soumet ses identifiants via l'interface de l'application, laquelle transmet la requête à l'API d'authentification. Le système procède ensuite à la vérification des informations fournies et contrôle le statut du compte de l'employé. Lorsque les identifiants sont valides et le compte actif, un jeton d'accès JWT est généré et l'utilisateur est redirigé vers son tableau de bord personnel. Dans le cas contraire, si les identifiants sont incorrects ou si le compte est désactivé, le système retourne un message d'erreur approprié signalant la raison du refus d'accès.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{projet/images/digf/ss1/auth.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{projet/images/digf/ss1/sinscrire.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{projet/images/digf/ss1/creer_compte_employe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{projet/images/digf/ss1/sup.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth ,height=1\textwidth]{projet/images/digf/ss1/mrc.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth ,height=1.1\textwidth]{projet/images/classe finale/diagramme_de_classe_s1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth ,height=0.5\textwidth]{projet/images/interface/s1/gestion employe.jpeg}
...
Comme pour le premier sprint, nous avons choisi dans ce sprint de décrire certaines tâches à l’aide
de diagrammes de séquence, afin d’illustrer de manière claire et structurée les différentes interactions
entre les objets du système ainsi que le déroulement des traitements effectués au sein de la plateforme. Ces diagrammes permettent de représenter l’enchaînement des messages échangés entre les
différents composants de l’application, depuis l’action initiée par l’utilisateur jusqu’à lexécution finale de l’opération. Ils offrent également une meilleure compréhension du comportement dynamique
du système et facilitent l’analyse des fonctionnalités développées durant ce sprint.

\subsubsection*{Diagramme de séquence du cas d'utilisation « Connecter la plateforme aux caméras »}

Ce diagramme de séquence illustre comment le Responsable RH configure et connecte les caméras à la plateforme. Il sélectionne les caméras d’entrée et de sortie via la page de configuration, qui communique avec l’API /terminal/recognize pour détecter les périphériques USB et initialiser le pointage automatique. Selon le résultat, le système confirme l’activation ou signale une erreur de connexion.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=0.85\textwidth]{projet/images/digf/ss2/connecter_cameras.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=0.85\textwidth]{projet/images/digf/ss2/enregister_visage.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=0.9\textwidth]{projet/images/digf/ss2/modifier_infos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=0.85\textwidth]{projet/images/digf/ss2/consulter_retard.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=0.85\textwidth]{projet/images/digf/ss2/pointage_facial.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,height=1\textwidth]{projet/images/classe finale/daigramme_de_classe_s2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{projet/images/interface/s2/enregister visage.png}
